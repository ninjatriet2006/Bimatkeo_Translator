...
- MODULE: app.core.translator.base_offline
- RESPONSIBILITY: base_offline.py module logic.
- CALLED BY: Various
- CALLS TO: Various
- IN = OUT: Defines logic for app.core.translator.base_offline.
=============================================================================
"""
import os
...
class BaseOfflineTranslator(BaseTranslator):
    def __init__(self):
        self.tokenizer = None
        self.model = None
        self.device = "cuda" if check_transformers() else "cpu"
    ...
    def translate(self, texts: List[str], src_lang: str, tgt_lang: str, context_texts: List[str] | None = None) -> List[Union[str, dict]]:
        ...
        return final_texts  # type: ignore
