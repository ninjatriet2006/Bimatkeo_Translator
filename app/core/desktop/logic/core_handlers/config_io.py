...
- CALLS TO: app.core.desktop.logic.config_io_manager
...
class ConfigIOHandlersMixin:
    def _get_yaml_config_path(self, filename: str) -> str:
        from app.core.desktop.logic.config_io_manager import get_yaml_config_path
    ...
    def _save_yaml_config(self, filename: str, data: dict, wrap_key: str | None = None):
        from app.core.desktop.logic.config_io_manager import save_yaml_config
