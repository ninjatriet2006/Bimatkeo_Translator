...
- MODULE: app.plugins.detector.craft.loader
- RESPONSIBILITY: Tải mô hình CRAFT (Download/Extract/Load vào RAM/VRAM).
...
def load_craft_model(model_path: str | None = None, log_callback=None, **kwargs):
    if not model_path:
    ...
    if log_callback: 
        log_callback("INFO", f"Mô hình CRAFT đã nạp: {model_path}")
